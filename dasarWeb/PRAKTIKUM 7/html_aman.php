<html>
    ...
    <body>
        <fieldset>
            <h3 style="text-align: center;">Form Input PHP</h3>
            ...
            <form method="post" action="">
                ...
                <br><br>
                <input style="margin: auto; display: block; background-color: rgb(252, 190, 23);" type="submit" name="submit" value="Submit">
            </form>
